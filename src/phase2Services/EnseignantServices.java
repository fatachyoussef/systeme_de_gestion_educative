    ...
    public static Enseignant getEnsById(int id) {
        ...
        try (Connection conn = DatabaseConnector.getConnection();
            ...
            if (rs.next()) {
                ...
                Departement dept = phase2Services.DepartementServices.getDeptById(deptId); // This method should be implemented in DepartementServices
    ...
    public static ArrayList<Enseignant> getAllEns() {
        ...
        try (Connection conn = DatabaseConnector.getConnection();
            ...
            while (rs.next()) {
                ...
                Departement dept = phase2Services.DepartementServices.getDeptById(deptId);
