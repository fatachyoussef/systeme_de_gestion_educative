...
public class DepartementsController {
    ...
    public static void showDepartements() {
        phase2Services.DepartementServices DepartementServices = new phase2Services.DepartementServices();
    ...
    public static void createDepartement() {
        ...
        phase2Services.DepartementServices.addDept(intitule, EnseignantServices.getEnsById(id));
    ...
    public static void editDepartement() {
        ...
        Departement updatedDept = phase2Services.DepartementServices.updateDept(id, intitule, EnseignantServices.getEnsById(idEns));
        if (updatedDept != null) {
    ...
    public static void destroyDepartement() {
        showDepartements();
        int id = Main.getIntInput("Sélectionnez un département par id :");
        boolean deleted = phase2Services.DepartementServices.deleteDeptById(id);
        if (deleted) {
