...
import phase2Services.EtudiantServices;
...
public class EtudiantsController {
    ...
    public static void showEtudiants() {
        for (Etudiant etudiant : phase2Services.EtudiantServices.getAllEtd()) {
    ...
    public static void createEtudiant() {
        ...
        phase2Services.EtudiantServices.addEtd(nom, prenom, email, apogee, filiere);
    ...
    public static void editEtudiant() {
        ...
        Filiere filiere = phase2Services.FiliereServices.getFiliereById(filiereId);

        phase2Services.EtudiantServices.updateEtd(id, nom, prenom, email, apogee, filiere);
