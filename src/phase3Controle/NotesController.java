...
import phase2Services.NoteServices;
...
public class NotesController {
    ...
    private static void addNote() {
        float grade = phasemain.Main.getFloatInput("Enter the note: ");
        int studentId = phasemain.Main.getIntInput("Enter student ID: ");
        int filiereId = phasemain.Main.getIntInput("Enter filiere ID: ");
    ...
    private static void updateNote() {
        int noteId = phasemain.Main.getIntInput("Enter note ID: ");
        float newGrade = phasemain.Main.getFloatInput("Enter new grade: ");
    ...
    private static void deleteNote() {
        int noteId = phasemain.Main.getIntInput("Enter note ID to delete: ");
